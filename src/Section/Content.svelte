...
<div class="content">
  <div class="content-test">
    <h3 id="ReportSummary" style="margin-top:0;">
    ...
    <h5 id="ElectronicDesignProcess">{$lang.electronicdesignprocessHeader}</h5>
    ...
    <figure>
      ...
      />
      <figcaption>
        Fig.20 - Computer vision examples: gate detection using YOLO and path
        axis detection using OpenCV.
      </figcaption>
    </figure>
    <hr />
